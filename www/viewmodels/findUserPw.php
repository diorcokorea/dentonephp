...
/********************************************************
    비밀번호 찾기 KMC 본인인증 return 값 복호화 페이지 
********************************************************/
...
<form name="result_form" id="result_form" method="post" action="../views/findMemberPassword.php" >
<input type="hidden"  id="certification_suces" name="certification_suces"  value='true'/> 

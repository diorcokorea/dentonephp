...
<meta http-ｅquiv="Content-Type" content="text/html; charset=utf-8" />
  <head>
    <style>
      @page{
        margin-top: 375px; /* create space for header */
	  ...
	  .bold {font-family:'NanumGothicBold';}
		.new_page_break { page-break-after: always; }
  ...
  <body>
	...
	<footer>
      <table style="border:1px solid #707070;width:100%" cellpadding="10" cellspacing="0">
			<tr>
				<td style="">Written in : 07-21-2021</td>
				<td style="" align="right">Page <span class="page"></span></td>
			</tr>
		</table>
    </footer>
    ...
    <main>
		<div class="page_break">
			...
			<div style="border:1px solid #707070;width:100%;padding:10px 0">
				<table cellpadding="10px" style="margin-bottom:10px">
					<tr>
						<td style="padding-left:80px;width:20%" valign="top">Status</td>
						<td style="width:4%" align="center" valign="top">:</td>
						<td style="padding-right:80px;width:76%" valign="top">$classification</td>
					</tr>
					<tr>
						<td style="padding-left:80px;width:20%" valign="top">Etc</td>
						<td style="padding-right:80px;width:80%" valign="top" colspan="2"><input type="text" value="$etc" style="width:100%;height:120px;padding:10px;border-radius:5px"></td>
					</tr>
					<tr>
						<td style="padding-left:80px">Note</td>
					</tr>
					<tr>
						<td style="padding:0 80px" colspan="3"><input type="text" value="$precaution" style="width:100%;height:225px;padding:10px;border-radius:5px"></td>
					</tr>
				</table>
			</div>
		</div>
		<div class="page_break">
			...
			<div style="border:1px solid #707070;width:100%;padding:23px 30px;text-align:center">
				<table class="photo" style="width:100%" cellspacing="10px" cellpadding="1px">
					<tr>
						<td style="border:1px solid #707070;height:170px;width:30%;" align="center" valign="middle"><img src="$lateral_photo" style="width:100%;"></td>
						<td style="border:1px solid #707070;height:170px;width:30%" align="center" valign="middle"><img src="$front_photo" width="100%"></td>
						<td style="border:1px solid #707070;height:170px;width:30%" align="center" valign="middle"><img src="$smile_photo" width="100%"></td>
					</tr>
					<tr>
						<td style="border:1px solid #707070;height:170px;width:30%" align="center" valign="middle"><img src="$intraoral_upper" width="100%"></td>
						<td style="border:1px solid #707070;height:170px;width:30%" align="center" valign="middle">This is a registerd photo.</td>
						<td style="border:1px solid #707070;height:170px;width:30%" align="center" valign="middle"><img src="$intraoral_lower" width="100%"></td>
					</tr>
					<tr>
						<td style="border:1px solid #707070;height:170px;width:30%" align="center" valign="middle"><img src="$intraoral_right" width="100%"></td>
						<td style="border:1px solid #707070;height:170px;width:30%" align="center" valign="middle"><img src="$intraoral_fornt" width="100%"></td>
						<td style="border:1px solid #707070;height:170px;width:30%" align="center" valign="middle"><img src="$intraoral_left" width="100%"></td>
					</tr>
				</table>
			</div>
		</div>
		<div class="page_break">
			...
			<div style="border:1px solid #707070;width:100%;padding:92px 50px;text-align:center">
				<table class="xray" style="height:auto;width:100%" cellspacing="30px" cellpadding="1px">
					<tr>
						<td style="border:1px solid #707070;height:360px;width:40%" align="center" valign="middle"><img src="$lateral_xray" style="width:100%;"></td>
						<td style="border:1px solid #707070;height:360px;width:40%" align="center" valign="middle"><img src="$panorama" width="100%"></td>
					</tr>
				</table>
			</div>
		</div>
		<div class="page_break">
			...
			<div style="border:1px solid #707070;width:100%;padding:188px 40px">
		...
		<div class="page_break">
			...
			<div style="border:1px solid #707070;width:100%;padding:153px 40px;">
				<table style="width:100%" cellpadding="0" cellspacing="0">
					<tr>
				...
				<table style="width:100%;margin-top:50px" cellspacing="0" cellpadding="5px 0">
					<tr>
					...
					<tr>
						...
						<td style="width:5%">:</td>
						<td style="width:20%">Protrusion</td>
		...
		<div class="page_break">
			...
			<div style="border:1px solid #707070;width:100%;padding:160px 40px;">
				...
				<table style="width:100%;margin-top:60px" cellpadding="5px 0" cellspacing="0">
					<tr>
		...
		<div class="page_break">
			<table style="width:100%;margin-top:10px" cellpadding="10px" cellspacing="0">
				<tr>
					<td style="background-color:#000;color:#fff;font-size:14" class="bold">Prescription4</td>
				</tr>
			</table>
			<div style="border:1px solid #707070;width:100%;padding:175px 40px;">
				<table style="width:100%;" cellpadding="5px 0" cellspacing="0">
					<tr>
						<td style="width:35%" Valign="top"><h3 style="margin:0">8. Occlusal opening device</h3></td>
						<td style="width:5%" Valign="top">:</td>
						<td style="" style="text-align:left" Valign="top">Bite ramp on the lingual side of the maxilla / Incisor / Lateral incisor</td>
					</tr>
				</table>
				<table style="width:100%;margin-top:50px" cellpadding="5px 0" cellspacing="0">
					<tr>
						<td style="width:35%"><h3 style="margin:0">9. Extraction</h3></td>
						<td style="width:5%">:</td>
						<td style="" style="text-align:left">Extraction</td>
					</tr>
				</table>
				<table class="bracket" style="margin-top:10px" cellpadding="0" cellspacing="0">
					<tr class="top">
						<td rowspan="2" style="border:none;padding:0 5px 0 0"><div style="background-color:#dadada;padding:35px 8px">R</div></td>
		...
		<div class="page_break">
			...
			<div style="border:1px solid #707070;width:100%;padding:108px 40px;">
				<table style="width:100%" cellpadding="5px 0" cellspacing="0">
					<tr>
					...
					<tr>
						...
						<td style="width:5%">:</td>
						<td style="" style="text-align:left">Select teeth for compensation</td>
					</tr>
				</table>
				...
				<table style="width:100%;margin-top:20px" cellpadding="5px 0" cellspacing="0">
					<tr>
				...
				<table style="width:100%;margin-top:10px" cellpadding="5px 0" cellspacing="0">
					<tr>
						...
						<td style="width:10%" style="text-align:left"><input type="text" value="1.0" style="height:24px;width:50px;vertical-align:middle;text-align:center;border-radius:5px"></td>
					</tr>
				</table>
			</div>
		</div>
		<div>
			...
			<div style="border:1px solid #707070;width:100%;padding:10px 40px;">
				<table style="width:100%;" cellpadding="5px 0" cellspacing="0">
					...
					<tr>
						<td style=""><input type="text" value="$special_instruction" style="width:100%;height:520px;padding:10px;border-radius:5px"></td>
					</tr>
				</table>
			</div>
		</div>

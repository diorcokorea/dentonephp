...
//print_r( $service_info_array[12] );
       // print_r($shipping_address);

       // print_r( $idb_try_option );
        // print_r( $idb_try_section_u );
        // print_r( $idb_try_section_l );
       //  print_r( $bracket_info );

        // print_r( $ext_option );
        // print_r( $ext_toooth_list );

        // print_r( $ipr_option );

        // print_r( $maintain_asis_u );
        // print_r( $maintain_asis_l );
        ...
        // $model_mx = $_SESSION['model_mx'];
        // $model_md = $_SESSION['model_md'];
        ...
        // $idb_try_option = $_SESSION['idb_try_option'];
        // $idb_try_section_u = $_SESSION['idb_try_section_u'];
        // $idb_try_section_l = $_SESSION['idb_try_section_l'];
        // $bracket_info = $_SESSION['bracket_info'];




        // $ext_option = $_SESSION['ext_option'];
        // $ext_toooth_list = $_SESSION['ext_toooth_list'];
        // $ipr_option = $_SESSION['ipr_option'];
        // $maintain_asis_u = $_SESSION['maintain_asis_u'];
        // $maintain_asis_l = $_SESSION['maintain_asis_l'];
        // $widen_u = $_SESSION['widen_u'];
        // $widen_l = $_SESSION['widen_l'];

        // $constrict_u = $_SESSION['constrict_u'];
        // $constrict_l = $_SESSION['constrict_l'];
        // $lower_occ_plane = $_SESSION['lower_occ_plane'];

        // $overbite = $_SESSION['overbite'];
        // $overbite_value = $_SESSION['overbite_custom_n'];

        // $overjet = $_SESSION['overjet'];
        // $overjet_value = $_SESSION['overjet_custom_n'];

        // $cc = $_SESSION['complaint'];
        // $diagnostics = $_SESSION['diagnostics'];

$config['cf_title'] = "Order Summary";
				...
				<div style="width:70%;margin:0 auto">
					<div class="patient_left" style="float:left;">
						<div class="patient" style="margin-bottom:70px">
							...
							<span>:</span>
							<p style="white-space: pre-wrap; width: 220px; vertical-align: middle;"><?=$patient_info_array[0]?></p>
						</div>
						<div class="patient" style="margin-bottom:70px">
							<p class="result_patient_title">First name</p>
							<span>:</span>
							<p class="result_patient_content" style="white-space: pre-wrap; width: 220px; vertical-align: middle;"><?=explode( ',', $patient_info_array[1] )[0]?></p>
						</div>
						<div class="patient" style="margin-bottom:70px">
							<p class="result_patient_title">Last name</p>
							<span>:</span>
							<p class="result_patient_content" style="white-space: pre-wrap; width: 220px; vertical-align: middle;"><?=explode( ',', $patient_info_array[1] )[1]?></p>
						</div>
						<div class="patient" style="margin-bottom:70px">
						...
						<div class="patient">
							...
							<span>:</span>
							<p class="result_patient_content"><?=$patient_info_array[6]?></p>
						</div>
					</div>
					<div class="patient_right" style="float: right;">
						...
						<div class="patient" style="margin-bottom:70px">
							...
							<span>:</span>
                            <p style="color:#07a2e8"><?=$shipping_address['address_name']?></p>
						...
						<div class="patient">
							...
							<span>:</span>
                            <p style="color:#07a2e8"><?=$billing_address['address_name']?></p>
							<p style="margin-left:187px;margin-top:10px">
			...
			<div class="result_content" style="padding:40px 200px">
				<div>
					<div class="patient">
						...
						<p>
						<? $md = $model_type;
							if($model_mx != null && $model_md != null){
								$md = $md." : "."Maxilla, Mandible";
							}else if($model_mx != null){
								$md = $md." : "."Maxilla";
							}else if($model_md != null){
								$md = $md." : "."Mandible";
							}
							echo $md;
						?>
			...
			<div class="result_content" style="padding:50px 95px">
				...
				<div class="used_brackets" style="margin-top:40px;overflow:hidden;">
					...
					<div style="overflow:hidden;display:inline-block;margin:0 0 0 20px">
						...
						<? include("./service/setup2_layer.php");  ?>
...
<!-- Adults result 끝 -->
<!-- Child result 시작 -->
 <?} else if($treatment_option1 == "Child"){  ?>
	<!-- Prescription1 Start -->
		<div id="result_bracket" class="result_box" style="margin-top:40px">
			<div class="title" style="overflow:hidden;">
				<p style="font-size:20px">Prescription1</p>
						...
						<div style="overflow:hidden;display:inline-block">
							...
							<div style="overflow:hidden;display:inline-block;float:left">
								<div style="border-bottom:1px solid #3c3c3c;overflow:hidden;padding-left:5px;padding-bottom:5px">
									...
									<button type="button" disabled class="number" id="diagnostics_24" name="upperBrackets" >24</button>
									<button type="button" disabled class="number" id="diagnostics_25" name="upperBrackets" >25</button>
									<button type="button" disabled class="number" id="diagnostics_26" name="upperBrackets"  style="margin:0">26</button>
								</div>
								<div style="padding-top:5px;overflow:hidden;padding-left:5px">
									<button type="button" disabled class="number" id="diagnostics_31" name="lowerBrackets" >31</button>
									<button type="button" disabled class="number" id="diagnostics_32" name="lowerBrackets" >32</button>
									...
									<button type="button" disabled class="number" id="diagnostics_34" name="lowerBrackets" >34</button>
									<button type="button" disabled class="number" id="diagnostics_35" name="lowerBrackets" >35</button>
									<button type="button" disabled class="number" id="diagnostics_36" name="lowerBrackets"  style="margin:0">36</button>
								</div>
							</div>
							<p class="RL" style="margin-left:5px">L</p>
							...
							<div style="overflow:hidden;display:inline-block;float:left">
								<div style="border-bottom:1px solid #3c3c3c;overflow:hidden;padding-bottom:5px;border-right:1px solid #3c3c3c;padding-right:5px">
									<button type="button" disabled class="number" id="diagnostics_55" name="upperBrackets" >55</button>
									<button type="button" disabled class="number" id="diagnostics_54" name="upperBrackets" >54</button>
									<button type="button" disabled class="number" id="diagnostics_53" name="upperBrackets" >53</button>
									<button type="button" disabled class="number" id="diagnostics_52" name="upperBrackets" >52</button>
									<button type="button" disabled class="number" id="diagnostics_51" name="upperBrackets"  style="margin:0">51</button>
								</div>
								<div style="padding-top:5px;border-right:1px solid #3c3c3c;padding-right:5px;overflow:hidden">
									<button type="button" disabled class="number" id="diagnostics_85" name="lowerBrackets" >85</button>
									<button type="button" disabled class="number" id="diagnostics_84" name="lowerBrackets" >84</button>
									<button type="button" disabled class="number" id="diagnostics_83" name="lowerBrackets" >83</button>
									<button type="button" disabled class="number" id="diagnostics_82" name="lowerBrackets" >82</button>
									<button type="button" disabled class="number" id="diagnostics_81" name="lowerBrackets" style="margin:0">81</button>
								</div>
							</div>
							<div style="overflow:hidden;display:inline-block;float:left">
								<div style="border-bottom:1px solid #3c3c3c;overflow:hidden;padding-left:5px;padding-bottom:5px">
									<button type="button" disabled class="number" id="diagnostics_61" name="upperBrackets" >61</button>
									<button type="button" disabled class="number" id="diagnostics_62" name="upperBrackets" >62</button>
									<button type="button" disabled class="number" id="diagnostics_63" name="upperBrackets" >63</button>
									<button type="button" disabled class="number" id="diagnostics_64" name="upperBrackets" >64</button>
									<button type="button" disabled class="number" id="diagnostics_65" name="upperBrackets" style="margin:0">65</button>
								</div>
								<div style="padding-top:5px;overflow:hidden;padding-left:5px">
									<button type="button" disabled class="number" id="diagnostics_71" name="lowerBrackets" >71</button>
									<button type="button" disabled class="number" id="diagnostics_72" name="lowerBrackets" >72</button>
									<button type="button" disabled class="number" id="diagnostics_73" name="lowerBrackets" >73</button>
									<button type="button" disabled class="number" id="diagnostics_74" name="lowerBrackets" >74</button>
									<button type="button" disabled class="number" id="diagnostics_75" name="lowerBrackets" style="margin:0">75</button>
								</div>
							</div>
							<p class="RL" style="margin-left:5px">L</p>
							</div>
				...
				<div class="used_brackets" style="overflow:hidden;">
					...
					<div style="overflow:hidden;display:inline-block;float:left">
						<div style="border-bottom:1px solid #3c3c3c;overflow:hidden;padding-left:5px;padding-bottom:5px">
							...
							<button type="button" disabled class="number" id="attchment_24" name="upperBrackets" >24</button>
							<button type="button" disabled class="number" id="attchment_25" name="upperBrackets" >25</button>
							<button type="button" disabled class="number" id="attchment_26" name="upperBrackets"  style="margin:0">26</button>
						</div>
						<div style="padding-top:5px;overflow:hidden;padding-left:5px">
							<button type="button" disabled class="number" id="attchment_31" name="lowerBrackets" >31</button>
							<button type="button" disabled class="number" id="attchment_32" name="lowerBrackets" >32</button>
							...
							<button type="button" disabled class="number" id="attchment_34" name="lowerBrackets" >34</button>
							<button type="button" disabled class="number" id="attchment_35" name="lowerBrackets" >35</button>
							<button type="button" disabled class="number" id="attchment_36" name="lowerBrackets"  style="margin:0">36</button>
						</div>
					</div>
					<p class="RL" style="margin-left:5px">L</p>
					<div style="display:inline-block">
					...
					<div style="overflow:hidden;display:inline-block;float:left">
						<div style="border-bottom:1px solid #3c3c3c;overflow:hidden;padding-bottom:5px;border-right:1px solid #3c3c3c;padding-right:5px">
							<button type="button" disabled class="number" id="attchment_55" name="upperBrackets" >55</button>
							<button type="button" disabled class="number" id="attchment_54" name="upperBrackets" >54</button>
							<button type="button" disabled class="number" id="attchment_53" name="upperBrackets" >53</button>
							<button type="button" disabled class="number" id="attchment_52" name="upperBrackets" >52</button>
							<button type="button" disabled class="number" id="attchment_51" name="upperBrackets"  style="margin:0">51</button>
						</div>
						<div style="padding-top:5px;border-right:1px solid #3c3c3c;padding-right:5px;overflow:hidden">
							<button type="button" disabled class="number" id="attchment_85" name="lowerBrackets" >85</button>
							<button type="button" disabled class="number" id="attchment_84" name="lowerBrackets" >84</button>
							<button type="button" disabled class="number" id="attchment_83" name="lowerBrackets" >83</button>
							<button type="button" disabled class="number" id="attchment_82" name="lowerBrackets" >82</button>
							<button type="button" disabled class="number" id="attchment_81" name="lowerBrackets" style="margin:0">81</button>
						</div>
					</div>
					<div style="overflow:hidden;display:inline-block;float:left">
						<div style="border-bottom:1px solid #3c3c3c;overflow:hidden;padding-left:5px;padding-bottom:5px">
                            <button type="button" disabled class="number" id="attchment_61" name="upperBrackets" >61</button>
							<button type="button" disabled class="number" id="attchment_62" name="upperBrackets" >62</button>
							<button type="button" disabled class="number" id="attchment_63" name="upperBrackets" >63</button>
							<button type="button" disabled class="number" id="attchment_64" name="upperBrackets" >64</button>
							<button type="button" disabled class="number" id="attchment_65" name="upperBrackets" style="margin:0">65</button>
						</div>
						<div style="padding-top:5px;overflow:hidden;padding-left:5px">
							<button type="button" disabled class="number" id="attchment_71" name="lowerBrackets" >71</button>
							<button type="button" disabled class="number" id="attchment_72" name="lowerBrackets" >72</button>
							<button type="button" disabled class="number" id="attchment_73" name="lowerBrackets" >73</button>
							<button type="button" disabled class="number" id="attchment_74" name="lowerBrackets" >74</button>
							<button type="button" disabled class="number" id="attchment_75" name="lowerBrackets" style="margin:0">75</button>
						</div>
					</div>
					<p class="RL" style="margin-left:5px">L</p>
					</div>
				...
				<div class="used_brackets">
					...
					<div style="overflow:hidden;margin:0 0 0 30px;text-align:left">
						...
						<div style="overflow:hidden;display:inline-block;float:left">
							<? include("./service/setup2_layer.php");  ?>
							<div style="border-bottom:1px solid #3c3c3c;overflow:hidden;padding-bottom:5px;border-right:1px solid #3c3c3c;padding-right:5px">
								<button type="button" disabled class="number" id="extraction_16" name="upperBrackets" >16</button>
								<button type="button" disabled class="number" id="extraction_15" name="upperBrackets" >15</button>
								<button type="button" disabled class="number" id="extraction_14" name="upperBrackets" >14</button>
								<button type="button" disabled class="number" id="extraction_13" name="upperBrackets" >13</button>
								<button type="button" disabled class="number" id="extraction_12" name="upperBrackets" >12</button>
								<button type="button" disabled class="number" id="extraction_11" name="upperBrackets"  style="margin:0">11</button>
							</div>
							<div style="padding-top:5px;border-right:1px solid #3c3c3c;padding-right:5px;overflow:hidden">
								<button type="button" disabled class="number" id="extraction_46" name="lowerBrackets" >46</button>
								<button type="button" disabled class="number" id="extraction_45" name="lowerBrackets" >45</button>
								<button type="button" disabled class="number" id="extraction_44" name="lowerBrackets" >44</button>
								<button type="button" disabled class="number" id="extraction_43" name="lowerBrackets" >43</button>
								<button type="button" disabled class="number" id="extraction_42" name="lowerBrackets" >42</button>
								<button type="button" disabled class="number" id="extraction_41" name="lowerBrackets"  style="margin:0">41</button>
							</div>
						</div>
						<div style="overflow:hidden;display:inline-block;float:left">
							<div style="border-bottom:1px solid #3c3c3c;overflow:hidden;padding-left:5px;padding-bottom:5px">
								<button type="button" disabled class="number" id="extraction_21" name="upperBrackets" >21</button>
								<button type="button" disabled class="number" id="extraction_22" name="upperBrackets" >22</button>
								<button type="button" disabled class="number" id="extraction_23" name="upperBrackets" >23</button>
								<button type="button" disabled class="number" id="extraction_24" name="upperBrackets" >24</button>
								<button type="button" disabled class="number" id="extraction_25" name="upperBrackets" >25</button>
								<button type="button" disabled class="number" id="extraction_26" name="upperBrackets"  style="margin:0">26</button>
							</div>
							<div style="padding-top:5px;overflow:hidden;padding-left:5px">
								<button type="button" disabled class="number" id="extraction_31" name="lowerBrackets" >31</button>
								<button type="button" disabled class="number" id="extraction_32" name="lowerBrackets" >32</button>
								<button type="button" disabled class="number" id="extraction_33" name="lowerBrackets" >33</button>
								<button type="button" disabled class="number" id="extraction_34" name="lowerBrackets" >34</button>
								<button type="button" disabled class="number" id="extraction_35" name="lowerBrackets" >35</button>
								<button type="button" disabled class="number" id="extraction_36" name="lowerBrackets"  style="margin:0">36</button>
							</div>
						</div>
						<p class="RL" style="margin-left:5px">L</p>
						<div style="display:inline-block">
							...
							<div style="overflow:hidden;display:inline-block;float:left">
								<div style="border-bottom:1px solid #3c3c3c;overflow:hidden;padding-bottom:5px;border-right:1px solid #3c3c3c;padding-right:5px">
									<button type="button" disabled class="number" id="extraction_55" name="upperBrackets" >55</button>
									<button type="button" disabled class="number" id="extraction_54" name="upperBrackets" >54</button>
									<button type="button" disabled class="number" id="extraction_53" name="upperBrackets" >53</button>
									<button type="button" disabled class="number" id="extraction_52" name="upperBrackets" >52</button>
									<button type="button" disabled class="number" id="extraction_51" name="upperBrackets"  style="margin:0">51</button>
								</div>
								<div style="padding-top:5px;border-right:1px solid #3c3c3c;padding-right:5px;overflow:hidden">
									<button type="button" disabled class="number" id="extraction_85" name="lowerBrackets" >85</button>
									<button type="button" disabled class="number" id="extraction_84" name="lowerBrackets" >84</button>
									<button type="button" disabled class="number" id="extraction_83" name="lowerBrackets" >83</button>
									<button type="button" disabled class="number" id="extraction_82" name="lowerBrackets" >82</button>
									<button type="button" disabled class="number" id="extraction_81" name="lowerBrackets" style="margin:0">81</button>
								</div>
							</div>
							<div style="overflow:hidden;display:inline-block;float:left">
								<div style="border-bottom:1px solid #3c3c3c;overflow:hidden;padding-left:5px;padding-bottom:5px">
									<button type="button" disabled class="number" id="extraction_61" name="upperBrackets" >61</button>
									<button type="button" disabled class="number" id="extraction_62" name="upperBrackets" >62</button>
									<button type="button" disabled class="number" id="extraction_63" name="upperBrackets" >63</button>
									<button type="button" disabled class="number" id="extraction_64" name="upperBrackets" >64</button>
									<button type="button" disabled class="number" id="extraction_65" name="upperBrackets" style="margin:0">65</button>
								</div>
								<div style="padding-top:5px;overflow:hidden;padding-left:5px">
									<button type="button" disabled class="number" id="extraction_71" name="lowerBrackets" >71</button>
									<button type="button" disabled class="number" id="extraction_72" name="lowerBrackets" >72</button>
									<button type="button" disabled class="number" id="extraction_73" name="lowerBrackets" >73</button>
									<button type="button" disabled class="number" id="extraction_74" name="lowerBrackets" >74</button>
									<button type="button" disabled class="number" id="extraction_75" name="lowerBrackets" style="margin:0">75</button>
								</div>
							</div>
							<p class="RL" style="margin-left:5px">L</p>
						</div>
...
if ($ext_option != "not_tooth_extraction") {
    $toooth_list =   explode(',',$ext_toooth_list[0]['tooth_number']); 

echo "<script>";
for ($i=0; $i < count($toooth_list); $i++) { 
	echo "$('#extraction_".$toooth_list[$i]."').css({'background':'url(../../resource/images/extraction_icon.png)', 'background-repeat' : 'no-repeat', 'background-position':'center'});
    $('#extraction_".$toooth_list[$i]."').text('');";
}
echo "</script>";
}
?>
...
if ($attchment_option == "select") {
echo "<script>";
for ($i=0; $i < count($attchment_list[0]); $i++) { 
	echo "$('#attchment_".$attchment_list[0][$i]."').css({'background-color':'#07a2e8', 'background-repeat' : 'no-repeat', 'background-position':'center'});";
}
echo "</script>";
}
?>
...
echo "<script>";
if ($eruption_incisor_option == "provide") {
	for ($i=0; $i < count($eruption_incisor_list[0]); $i++) { 
		echo "$('#incisor_".$eruption_incisor_list[0][$i]."').css({'background-color':'#07a2e8', 'background-repeat' : 'no-repeat', 'background-position':'center'});";
	}
}

if ($eruption_molar_option == "provide") {
	for ($i=0; $i < count($eruption_molar_list[0]); $i++) { 
		echo "$('#molar_".$eruption_molar_list[0][$i]."').css({'background-color':'#07a2e8', 'background-repeat' : 'no-repeat', 'background-position':'center'});";
	}
}
...
<div class="button_menu" style="position: unset; transform: none; margin: 40px auto 0 auto;">
	<form action="../../viewmodels/print.php" method="post" id="print_form" style="display:inline-block">
		<input type="button" class="btn_blue hover190" onclick=" printPopup();" value="Print">
...
for ($i=0; $i < count($diagnostics); $i++) { 
    ...
    $tp_array = explode(',',$diagnostics[$i]['tooth_number']);

    if($diagnostics[$i]['type'] == "Crown"){

        for ($j=0; $j < count($tp_array); $j++) { 
            echo "$('#diagnostics_".$tp_array[$j]."').css({'background':'url(../../resource/images/crown_icon.png)', 'background-repeat' : 'no-repeat', 'background-position':'center'});
            $('#diagnostics_".$tp_array[$j]."').text('');";
        }
     
    }else if($diagnostics[$i]['type'] == "Implant"){

        for ($j=0; $j < count($tp_array); $j++) { 
            echo "$('#diagnostics_".$tp_array[$j]."').css({'background':'url(../../resource/images/implant_icon.png)', 'background-repeat' : 'no-repeat', 'background-position':'center'});
            $('#diagnostics_".$tp_array[$j]."').text('');";
        }
        ...
        for ($j=0; $j < count($tp_array); $j++) { 
            echo "$('#diagnostics_".$tp_array[$j]."').css({'background':'url(../../resource/images/Telescopic_crown_icon.png)', 'background-repeat' : 'no-repeat', 'background-position':'center'});
            $('#diagnostics_".$tp_array[$j]."').text('');";
        }

    }else if($diagnostics[$i]['type'] == "Veneered crown"){

        for ($j=0; $j < count($tp_array); $j++) { 
            echo "$('#diagnostics_".$tp_array[$j]."').css({'background':'url(../../resource/images/Veneered_crown_icon.png)', 'background-repeat' : 'no-repeat', 'background-position':'center'});
            $('#diagnostics_".$tp_array[$j]."').text('');";
        }

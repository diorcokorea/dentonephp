...
?>
    <div class="serviceContainer">
        ...
        <div class="test">
            ...
            <div class="patientprofile_content">
                    ...
                    <div class="patient_text">
                        <div style="overflow:hidden">
                            ...
                            <a class="btn_black hover90" style="width:90px; height:50px; line-height:45px; margin:0px;"
                               id="patient_info_edit" href="./patientprofile_edit.php">Edit</a>
                        </div>
                ...
                <div class="memobox">
                    ...
                    <div class="form-group" style="position:relative; float:left; ">
                        <textarea class="form-control-sign_up" style="width:600px; height:120px;" id="memo"
                        ...
                        <div class="view_comment">
                            ...
                            <div class="message">
                                <? if ($comment_array[$i]['type_id'] == 1) { ?>
                                    <p class="dmessage"><?= $comment_array[$i]['content'] ?></p>
                                <? } else if ($comment_array[$i]['type_id'] == 2) { ?>
                                    <p class="lmessage"><?= $comment_array[$i]['content'] ?></p>
                                <? } ?>
            ...
            */?>
            <div class="patientprofile_content" style="background-color:#fff; height:886px;">
    <form id="service_info_form" name="service_info_form" action="../viewmodels/patientprofile_update.php"
        ...
        <div class="patient_inner">
            ...
            <div style="float:left;width:50%;padding-right:60px">
                ...
                <div class="patient_text" style="margin-bottom:40px">
            ...
            <div style="float:right;width:50%;border-left: 1px solid #d2d2d2;padding-left:40px">
                <div class="patient_text year-month-days" style="overflow:hidden;margin-bottom:30px;">
                    ...
                    <div class="year-month-days-container">
                        ...
                        <select class="" required oninvalid="this.setCustomValidity('Please choose the day.')"
                            ...
                            <option value="" <?php if ($dd == null) echo "selected"; ?> disabled hidden>Day</option>
                ...
                */
                ...
                <div style="width:100%; height:47px;margin-bottom:30px">

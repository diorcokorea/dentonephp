		...
		<ul>
			...
			<li <?php if ($service==3) echo " id=\"tab_select\""; ?> >
				...
				<? if ($service==3&&$progress_num>=3){
					...
					}else{echo "disabled"; } ?> style="width:180px;">Patient information</a>
			</li>
			<li <?php if ($service==4) echo " id=\"tab_select\""; ?> >
				...
				<? if ($service==4&&$progress_num>=4){
					...
					}else{echo "disabled"; } ?> style="width:130px;">Classification</a>
			</li>
			<li <?php if ($service==5) echo " id=\"tab_select\""; ?> >
				...
				<? if ($service==5&&$progress_num>=5){
					...
					echo "class=\"tab_on hover130\"";
					}else{echo "disabled"; } ?> style="width:130px;">Model type</a>
			</li>
			<li <?php if ($service==6) echo " id=\"tab_select\""; ?> >
				...
				<? if ($service==6&&$progress_num>=6){
					...
					echo "class=\"tab_on hover130\"";
					}else{echo "disabled"; } ?> style="width:130px;">Photo</a>
			</li>
			<li <?php if ($service==7) echo " id=\"tab_select\""; ?> >
				...
				<? if ($service==7&&$progress_num>=7){
					...
					echo "class=\"tab_on hover170\"";
					}else{echo "disabled"; } ?> style="width:170px;">X-ray image</a>
			</li>
			<li <?php if ($service==8) echo " id=\"tab_select\""; ?> >
				...
				<? if ($service==8&&$progress_num>=8){
					...
					}else{echo "disabled"; } ?> style="width:40px;">1</a>
			</li>
			<li <?php if ($service==9) echo " id=\"tab_select\""; ?> >
				...
				<? if ($service==9&&$progress_num>=9){
					...
					echo "class=\"tab_on hover40\"";
					}else{echo "disabled"; } ?> style="width:40px;">2</a>
			</li>
			<li <?php if ($service==10) echo " id=\"tab_select\""; ?> >
				...
				<? if ($service==10&&$progress_num>=10){
					...
					echo "class=\"tab_on hover40\"";
					}else{echo "disabled"; } ?> style="width:40px;">3</a>
			</li>
			<li <?php if ($service==11) echo " id=\"tab_select\""; ?> >
				<a id="11_setup4"  name="service_tab" href='javascript:void(0);'
				<? if ($service==11&&$progress_num>=11){
					echo "class=\"tab_on\"";
					} elseif (11<=$progress_num){
					echo "class=\"tab_on hover40\"";
					}else{echo "disabled"; } ?> style="width:40px;">4</a>
			</li>
			<li <?php if ($service==12) echo " id=\"tab_select\""; ?> >
				<a id="12_setup5"  name="service_tab" href='javascript:void(0);'
				<? if ($service==12&&$progress_num>=12){
					echo "class=\"tab_on\"";
					} elseif (12<=$progress_num){
					echo "class=\"tab_on hover40\"";
					}else{echo "disabled"; } ?> style="width:40px;">5</a>
			</li>
			<li <?php if ($service==13) echo " id=\"tab_select\""; ?> >
				<a id="13_summary"  name="service_tab" href='javascript:void(0);'
				<? if ($service==13&&$progress_num>=13){
					echo "class=\"tab_on\"";
					} elseif (13<=$progress_num){
					echo "class=\"tab_on hover140\"";
					}else{echo "disabled"; } ?> style="width:140px;">Summary</a>
			</li>		
	</div>
	<script>

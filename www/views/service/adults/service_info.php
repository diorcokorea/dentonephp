...
if(!isset($_SESSION['patient_key'])){
    $_SESSION['patient_key'] = patient_cu($_SESSION['patient_id'], $_SESSION['first_name'].",".$_SESSION['last_name'],
		$_SESSION['patient_sex'],$_SESSION['patient_date_yy']."-".$_SESSION['patient_date_mm']."-".$_SESSION['patient_date_dd']  ,$ethinicity_code,0, (int)$_SESSION['member_code']);
    ...
    // 수정 시
    $_SESSION['patient_key'] = patient_cu($_SESSION['patient_id'], $_SESSION['first_name'].",".$_SESSION['last_name'], $_SESSION['patient_sex'],$_SESSION['patient_date_yy']."-".$_SESSION['patient_date_mm']."-".$_SESSION['patient_date_dd'] ,$ethinicity_code ,(int)$_SESSION['patient_key'],(int)$_SESSION['member_code']);
}

            // $shipping_address = address_r($_SESSION['shipping_address']);
            // $billing_address = address_r($_SESSION['billing_address']);

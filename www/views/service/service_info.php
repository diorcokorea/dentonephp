...
// 13 결과 페이지 
    ...
    if (isset($_POST['input'])) {
            ...
            $return_json =  serviceinfo_encode((int)$_SESSION['service_key'],(int) $_SESSION['member_code'], 2,(int) $_SESSION['progress_num'], null,(int)$_SESSION['lab_code'], $st_value, null);
...
//print_r($return_array);
//exit;
if(isset($_SESSION['treatment_option1']) && $_POST['targetUrl'] != '01_treatment_option1.php' ){

echo "<script>location.href='./".$_SESSION['treatment_option1']."/".$_POST['targetUrl']."'</script>";

...
<input type="hidden" id="progress_num" name="progress_num" value="<? echo $progress_num; ?>" />
		...
		<div class="impression" id="impression_div" style="display:none">
			<div style="padding:75px 80px;border:2px solid #d2d2d2;text-align:left;border-radius:5px">
			...
			<span style="padding-left:10px;display: inline-block; width: 77%; vertical-align: top;"><?=labinfo_r($dent_lab[0])[0]['phone']?></span></p>
